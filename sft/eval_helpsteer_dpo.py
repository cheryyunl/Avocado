...
class ScriptArguments:
    ...
    dpo_model_path: Optional[str] = field(default='/cmlscratch/cheryunl/Avocado/dpo/output/dev/famo_dpo_helpsteer/best_checkpoint')
    wandb_name: Optional[str] = field(default='eval_helpsteer_dpo', metadata={"help": "Name for this experiment"})
