...
import wandb
from accelerate import Accelerator
from multi_task_utils import build_mt_dataset, MTDataCollatorForCompletionOnlyLM
from random_trainer import RWSFTTrainer
...
model_path = '/cmlscratch/cheryll/huggingface/cache/hub/models--meta-llama--Llama-2-7b-hf/snapshots/01c7f73d771dfac7d292323805ebc428287df4f9'
...
if exp_type == 'assistant':
    ...
    train_dataset = build_mt_dataset(tokenizer, split='train')  
